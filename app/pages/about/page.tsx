...
const AboutUsPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>About Us | Varanasi GRC – GRC Supplier in India</title>
        <meta
          name="description"
          content="Learn more about Varanasi GRC, a trusted supplier of Glass Reinforced Concrete (GRC) products in India. We specialize in GRC Jalis, Columns, Panels, and custom architectural designs for residential and commercial projects."
        />
        <meta
          name="keywords"
          content="About Varanasi GRC, GRC supplier India, GRC manufacturer Varanasi, Glass Reinforced Concrete India, GRC Jali supplier, GRC Panels and Columns"
        />
      </Head>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  content:
                    "Tailored designs meeting unique architectural needs",
                },
                {
                  icon: FiGlobe,
                  title: "Eco-Friendly",
